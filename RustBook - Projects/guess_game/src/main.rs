...
use std::io; //that's a library - technically called a prelude or preprocessor directive/Including extra features. //here ordering is a enum type and has variants like greater, less and equal - ordering is directly related to the cmp - comparing module!
fn main() {
